 ...
 */
package net.reflxction.bedwarshud;
...
import net.reflxction.bedwarshud.proxy.IProxy;
import net.reflxction.bedwarshud.settings.Settings;
import net.reflxction.bedwarshud.updater.UpdateManager;
import net.reflxction.bedwarshud.utils.Reference;

import java.io.File;

/**
 * BedwarsHUD: The mod template used by all of my mods
 */
@Mod(
...
public class BedwarsHUD {
     ...
     */
    static {
        config = new Configuration(new File("config/bedwars-hud.cfg"));
