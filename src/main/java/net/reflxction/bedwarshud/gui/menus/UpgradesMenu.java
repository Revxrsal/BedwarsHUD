...
public class UpgradesMenu extends Page {
    ...
    public void initGui() {
        addButtons(
                buttons.getSharpenedSwordsButton(),
                buttons.getReinforcedArmorButton(),
                buttons.getTrapsActivatedButton(),
                buttons.getGeneratorForgeButton(),
                buttons.getDragonBuffButton(),
                buttons.getHasteButton()
        );
        super.initGui();
    }
